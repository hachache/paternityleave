...
const linkClass =
  'inline-flex items-center gap-1.5 rounded-xl px-3 py-2 text-xs sm:text-sm font-semibold text-slate-700 transition-colors hover:bg-slate-100 hover:text-slate-900 focus-visible:outline focus-visible:outline-2 focus-visible:outline-offset-2 focus-visible:outline-brand-500';
...
export function PostPlanningNavBar({ showSupplementaryLink }: PostPlanningNavBarProps) {
  return (
    <nav
      className="sticky top-20 z-30 mb-8 max-w-3xl mx-auto scroll-mt-28"
      aria-label="Navigation après planification"
    >
      <div className="rounded-2xl border border-slate-200/80 bg-white/95 p-2 shadow-lg shadow-slate-200/40 backdrop-blur-md">
