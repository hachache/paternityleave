...
export function HeroHeader({ hasBirthDate, onResetRequest }: HeroHeaderProps) {
  ...
  return (
    <motion.header
      className="relative mb-4 text-center sm:mb-7"
      variants={fadeInUp}
    ...
    >
      ...
      <div className="mb-2.5 flex justify-center sm:mb-4">
        <button
          type="button"
          onClick={onResetRequest}
      ...
      <div className="mb-2 flex justify-center sm:mb-3">
        <span className="inline-flex items-center rounded-full border border-slate-200 bg-[#fafafc] px-3 py-1 text-[11px] font-medium uppercase tracking-[0.08em] text-slate-500">
          Version 2026
        </span>
      </div>

      <h1 className="mx-auto mb-2 max-w-full text-[2rem] font-semibold leading-[1.05] tracking-[-0.012em] text-[#1d1d1f] sm:mb-3 sm:text-[52px]">
        Congé <span className="text-brand-600">Paternité</span>
      </h1>
      <p className="mx-auto mb-0 max-w-[18rem] text-[15px] font-normal leading-[1.4] tracking-[-0.012em] text-slate-600 sm:max-w-2xl sm:text-[22px] sm:leading-[1.2]">
