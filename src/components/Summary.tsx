            ...
            {remainingBlocks.length > 0 ? (
              <div className="space-y-3">
                {remainingBlocks.map((block, index) => (
                  <div
                    key={index}
                    className="group flex items-center justify-between gap-3 p-3.5 sm:p-4 rounded-xl bg-white border border-slate-200 hover:border-red-200 hover:bg-red-50/30 transition-[background-color,border-color,box-shadow] duration-200 shadow-sm"
                  >
